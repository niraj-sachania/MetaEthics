...
![Website responsive views](docs/website-responsive-view.jpg)
...
![Mobile andDesktop Wireframe](docs/wireframes.png)
...
<summary>Mobile portrait (click)</summary>

![Mobile portrait screenshot](docs/final-mobile-portrait.png)

</details>

<details>

<summary>Mobile landscape (click)</summary>

![Mobile landscape screenshot](docs/final-mobile-landscape.png)

</details>

<details>

<summary>Tablet portrait (click)</summary>

![Tablet portrait screenshot](docs/final-tablet-portrait.png)
...
<summary>Desktop (click)</summary>

![Mobile tablet landscape screenshot](docs/final-desktop.png)

</details>

<details>

<summary>Wide screen (click)</summary>

![Mobile tablet landscape screenshot](docs/final-wide-display.png)
...
![HTML Validation Results](docs/validate-css.png)

**WebAIM WAVE Accessibility**

✓ **[WAVE Report](https://wave.webaim.org/report#/https://niraj-sachania.github.io/MetaEthics/)** – No errors, AIM score 9.9/10

![WAVE Accessibility Results](docs/validate-accessibility.png)
